                ...
                <h5 class="m-0"><?php echo $subtitle; ?></h5>
                  ...
                  <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_petugas" placeholder="id_petugas" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Tahun Bayar</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="tahun_dibayar" placeholder="tahun-dibayar" required>
                            </div>
                            </div>
                        <div class="form-group row">
